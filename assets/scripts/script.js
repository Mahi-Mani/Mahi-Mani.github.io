$(document).ready(function () {
  ...
  for (var i = 0; i < projects.length; i++) {
    if (i % 2 === 0) {
      ...
      var col1Div = $("<div>");
      addClassValue(col1Div, "col-sm-1 col-md-1 col-lg-1 col-xl-1");
      var col2Div = $("<div>");
      addClassValue(col2Div, "col-sm-5 col-md-5 col-lg-5 col-xl-5");
      ...
      var col3Div = $("<div>");
      col3Div.addClass("col-sm-5 col-md-5 col-lg-5 col-xl-5");
      addAttribute(col3Div, "data-aos", "flip-up");
      addAttribute(col3Div, "data-aos-duration", "1000");
      var col4Div = $("<div>");
      col4Div.addClass("col-sm-1 col-md-1 col-lg-1 col-xl-1");
      var wrapper = $("<div>");
      addClassValue(wrapper, "wrapper");
      var img2Tag = $("<img>");
  ...
  for (var i = 0; i < workExperience.length; i++) {
    ...
    var col1Div = $("<div>");
    addClassValue(col1Div, "col-lg-2 col-md-2 col-lg-2 col-xl-2");
    var col2Div = $("<div>");
    addClassValue(col2Div, "col-sm-1 col-md-1 col-lg-1 col-xl-1");
    var col3Div = $("<div>");
    addClassValue(col3Div, "col-sm-7 col-md-7 col-lg-7 col-xl-7");
    var col4Div = $("<div>");
    addClassValue(col4Div, "col-sm-2 col-md-2 col-lg-2 col-xl-2");
    var verticalDiv = $("<div>");
